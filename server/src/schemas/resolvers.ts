...
const resolvers = {
  Query: {
    ...
    getDeck: async (_parent: unknown, args: { id: string }, _context: Context): Promise<IDeck | null> => {
  ...
  Mutation: {
    ...
    archiveDeck: async (_parent: unknown, { id }: { id: string }, _context: Context): Promise<IDeck> => {
